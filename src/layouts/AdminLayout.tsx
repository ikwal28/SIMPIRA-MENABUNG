  ...
  return (
    <div className="flex h-screen h-[100dvh] bg-slate-100 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-slate-200 px-2 py-3 flex items-center justify-around z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
